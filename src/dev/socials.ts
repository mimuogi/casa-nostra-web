...
export const AUTHOR_IMAGES: { [key: string]: string } = {
	...
	"Equip de comunicació d'Ana Millán": "assets/web/targetes-autor-noticies/AnaMilánComunicació250x250.png",
	"Joan Usach": getEnvironmentPath("/assets/images/joan-usach-foto-periodista-250x250.png"),
...
export const AUTHOR_SOCIALS: { [key: string]: SocialNetworkSet } = {
	...
	"Equip de comunicació d'Ana Millán": {},
	"Joan Usach": {},
	"Casa Nostra": {
		spotify:
